...
from .Core.Api import (
    ...
    androidassets, androidpermissions, androidnativeactivity, androidstl, androidlargeheap,
    ndkversion, androidsign, androidkeystore, androidkeystorepass, androidkeyalias, androidjavafiles, androidjavalibs, androidactivityclass,
...
__all__ = [
    ...
    'androidminsdk', 'androidtargetsdk', 'androidcompilesdk',
    'androidabis', 'androidproguard', 'androidproguardrules',
    'androidassets', 'androidpermissions', 'androidnativeactivity', 'androidstl', 'androidlargeheap', 'androidjavafiles', 'androidjavalibs', 'androidactivityclass',
